...
//fix captalize
const passenger = 'bUntY';
const passengerLower = passenger.toLowerCase();
const passengerCaptlize =
  passengerLower[0].toUpperCase() + passenger.toLowerCase().slice(1);
console.log(passengerCaptlize);

// compairing emails
const email = 'hello@sravan.io';
console.log('original: ', email);

const loginEmail = '  Hello@Sravan.Io \n';
const lowerEmail = loginEmail.toLowerCase();
const trimmedEmail = lowerEmail.trim();
console.log('after preprocesssing ', trimmedEmail);
...
console.log('Index of 1st r: ', airline.indexOf('r'));
console.log('Index of next r in the str :', airline.lastIndexOf('r'));
console.log(airline.slice(0, 4));

console.log(airline.slice(0, airline.indexOf(' ')));
console.log(airline.slice(airline.lastIndexOf(' ') + 1));
console.log(airline.slice(-2));
console.log(airline.slice(1, -2)); // it start's with index 1 and gives by leaving last 2 charectors

// method
const checkMiddle = function (seat) {
  // B and E are middle seats
  const s = seat.slice(-1);
  if (s === 'B' || s === 'E') console.log('you got Middele seat 😉');
  else {
    console.log("lucky you didn't got MiddleSeat ");
  }
};
checkMiddle('11B');
checkMiddle('23C');
...
console.log(new String('sravan'));
console.log(typeof new String('sravan')); // o/p object
console.log(typeof new String('sravan').slice(1)); /*
...
/*
//Maps///
// this maps having to map values to keys it is just like object but diffrence is we can have any type of values in keys
const rest = new Map();
rest.set('name', 'Shagouze');
rest.set(1, 'Tollichoky', 'hyderabad');
rest.set(2, 'Gachobowlli', 'secudrabad');
// console.log(rest);
rest
  .set('catagorioes', ['Italian', 'Pizzeria', 'Vegetarian', 'Organic'])
  .set('open', 11)
  .set('close', 23)
...
console.log(rest.has('catagorioes'));
rest.delete(2);
const arr = [1, 2];
rest.set(arr, 'Test');
rest.set(document.querySelector('h1'), 'headder');
